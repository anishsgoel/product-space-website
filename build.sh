...
# Public pages + code
cp index.html about.html clients.html apply.html 404.html \
   fellowship.html project-teams.html community.html \
   careers.html students.html \
   styles.css script.js dist/

# Public asset directories
cp -R team testimonials Logos icons fonts img dist/
